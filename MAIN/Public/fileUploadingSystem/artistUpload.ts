const APIcontroller = (function(){
    const cliendId = 'd93b29fc7e23418d902c640d9fa04579';
    const clientSecret = '2d2d026500254369bcf690a008ac1524';
...
const APPController = (function(UICtrl, APICtrl){
    ...
    DOMInputs.genre.addEventListener('change', async ()=> {
        ...
        //get the token, add method to store the token on the page so we don't have to keep the api for the token
        const token = UICtrl.getStoredToken().token;
        //get the genre select field
        const genreSelect = UICtrl.inputField().genre;
        //get the selected genereId
