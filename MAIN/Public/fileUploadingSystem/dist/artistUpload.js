var redirect_uri = "http://127.0.0.1:5500/MAIN/Public/fileUploadingSystem/artistUpload.html";
var client_id = "";
var client_secret = "";
...
function requestAuthorization() {
    client_id = document.querySelector("#clientId").value;
    client_secret = document.querySelector("#clientSecret").value;
